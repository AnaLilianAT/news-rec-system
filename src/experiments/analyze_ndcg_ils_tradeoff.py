...
Uso:
    python src/experiments/analyze_ndcg_ils_tradeoff.py
    python src/experiments/analyze_ndcg_ils_tradeoff.py --input outputs/experiments/embedding_dim_seed_sweep_agg.parquet
    python src/experiments/analyze_ndcg_ils_tradeoff.py --alphas 0.0 0.25 0.5 0.75 1.0
"""
